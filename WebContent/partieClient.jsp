...
<title><c:if test="${sessionScope.lang == 'en'}"> Customer </c:if>
	<c:if test="${sessionScope.lang == 'ar'}">الزبون </c:if> <c:if
		test="${sessionScope.lang == 'fr'}">Client</c:if></title>
		...
		<div class="content">
			<div class="container-fluid">
				...
				<div class="">
					...
					<c:if test="${sessionScope.lang == 'en'}"> <h3>Customer Mrs/Mr ${NomCompte}</h3> </c:if>
	<c:if test="${sessionScope.lang == 'ar'}"><h3 align="right">${NomCompte} الزبون السيدة / السيد </h3></br> </c:if> <c:if
		test="${sessionScope.lang == 'fr'}"> <h3>Client Mme/Mr ${NomCompte}</h3> </c:if>
