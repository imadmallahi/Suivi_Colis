...
<title><c:if test="${sessionScope.lang == 'en'}"> Registration as Distributor </c:if>
	<c:if test="${sessionScope.lang == 'ar'}">تسجيل الموزع </c:if> <c:if
				...
				<div class="card card-wizard" data-color="green" id="wizardProfile">
					<form action="Servlet" method="post" enctype="multipart/form-data">
						...
						<div class="card-header text-center">
							...
							<h5 class="card-description" style="color:red; ">
								<c:if test="${sessionScope.lang == 'en'}">The email address or phone number you entered already exists</c:if>
								<c:if test="${sessionScope.lang == 'ar'}">عنوان البريد الإلكتروني أو رقم الهاتف الذي أدخلته تم استعماله من قبل </c:if>
								<c:if test="${sessionScope.lang == 'fr'}">L'adresse email ou le numéro de téléphone que vous avez saisi existe déjà </c:if>
							</h5>
											...
											<div class="input-group-prepend">
												...
												<div class="form-group col-sm-4">
													<label for="examplenom" class="bmd-label-floating">Name
														...
														id="exampleInput1" name="nom" value="${attente.getNom()}" required>
												...
												<div class="form-group col-sm-4">
													<label for="examplemail" class="bmd-label-floating">Email
														...</label> <input type="text" class="form-control"
														id="exampleemalil" name="email" value="${attente.getEmail()}" required>
												</div>
												 </c:if>
											<c:if test="${sessionScope.lang == 'ar'}">
											<div class="form-group col-sm-4">
										...
										<div class="input-group form-control-lg">
												...
												<div class="form-group col-sm-8">
													<label for="exampleadress" class="bmd-label-floating" >address
														...</label> <input type="text" class="form-control"
														id="exampleemalil" name="adresse" value="${attente.getAdresse()}" required>
												</div>
												</c:if>
												...
												<c:if test="${sessionScope.lang == 'en'}">
													...
													<div class="form-group">
														<label for="exampleInput1" class="bmd-label-floating">Phone Number...</label> <input type="text" class="form-control"
															...
															onkeyup="verif_nombre(this);" value="${attente.getNtele()}" required>
													</div>
												</c:if>
												<c:if test="${sessionScope.lang == 'ar'}">
												...
												<div class="input-group-prepend">
													...
													<div class="form-group">
														<label for="exampleInput1" class="bmd-label-floating">Numéro
															...
															id="exampleInput1" name="tel"
															onkeyup="verif_nombre(this);" value="${attente.getNtele()}">
													</div>
												</c:if>
						...
						<div class="card-footer">
							...
							<c:if test="${sessionScope.lang == 'en'}">
								<button type="button"
									...
									value="Suivant" name="Suivant">Next</button> 
								<button type="submit"
									class="btn btn-finish btn-fill btn-success btn-wd"
									name="action" value="ajoutDistributeur" onclick="return verification();">Register</button> 
							</c:if>
							<c:if test="${sessionScope.lang == 'fr'}">
								<button type="button"
									class="btn btn-next btn-fill btn-success btn-wd" 
									value="Suivant" name="Suivant">Suivant</button> 
								<button type="submit"
									class="btn btn-finish btn-fill btn-success btn-wd"
									name="action" value="ajoutDistributeur" onclick="return verification();">S'inscrire</button> 
							</c:if>
								<c:if test="${sessionScope.lang == 'ar'}">
									<button type="button"
									class="btn btn-next btn-fill btn-success btn-wd" 
									value="Suivant" name="Suivant">التالي</button> 
									<button type="submit"
									class="btn btn-finish btn-fill btn-success btn-wd"
									name="action" value="ajoutDistributeur" onclick="return verification();">تسجيل</button> 
								</c:if>
