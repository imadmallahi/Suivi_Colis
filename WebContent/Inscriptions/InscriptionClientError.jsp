					...
					<form action="Servlet" method="post" enctype="multipart/form-data">
											...
											<c:if test="${sessionScope.lang == 'en'}">
												...
												<div class="form-group col-sm-4">
													<label for="exampleville" class="bmd-label-floating">Country
														...</label> <input type="text" class="form-control"
														id="" name="pays" value="${attente.getPaye()}" required>
												</div>
												<div class="input-group-prepend">
													<span class="input-group-text"> <i
														class="material-icons">home</i>
												...
												<div class="form-group  col-sm-4">
													<label for="exampleville" class="bmd-label-floating">City
														...</label> <input type="text" class="form-control"
														id="" name="ville" value="${attente.getVille()}" required>
												</div>
											</c:if>
											<c:if test="${sessionScope.lang == 'ar'}">
												<div class="form-group  col-sm-4">
											...
											<c:if test="${sessionScope.lang == 'fr'}">
												...
												<div class="form-group col-sm-4">
													<label for="exampleville" class="bmd-label-floating">Ville
														...</label> <input type="text" class="form-control"
														id="exampleemalil" name="pays" value="${attente.getPaye()}" required>
												</div>
												<div class="input-group-prepend">
													<span class="input-group-text"> <i
														class="material-icons">home</i>
										...
										<c:if test="${sessionScope.lang == 'en'}">
											...
											<div class="form-group">
												<label for="exampleusername" class="bmd-label-floating">Pseudo
													...</label> <input type="text" class="form-control"
													id="exampleInput1" name="username" value="${attente.getAdresse()}" >
											</div>
										</c:if>
										<c:if test="${sessionScope.lang == 'ar'}">
											<div class="form-group">
												...
												<c:if test="${sessionScope.lang == 'en'}">
													...
													<div class="form-group">
														<label for="exampleInput1" class="bmd-label-floating">Phone
															...
															class="form-control" id="exampleInput1" name="tel"
															onkeyup="verif_nombre(this);"
															value="${attente.getNtele()}" required>
													</div>
												</c:if>
												<c:if test="${sessionScope.lang == 'ar'}">
													<div class="form-group">
						...
						<div class="card-footer">
							...
							<c:if test="${sessionScope.lang == 'ar'}">
								...
								<button type="submit"
									class="btn btn-finish btn-fill btn-success btn-wd"
									name="action" value="ajoutClient" onclick="return verification();">تسجيل</button> 
							</c:if>
...
<script type="text/javascript">
	...
	function verification(){
		 ...
		 if(file.size>1000000) { $('#wizard-picture').val("");
			 alert("La taille de l'image ne doit pas dépasser 1Mo"); return false;} 
		 else return true; 
	}
