...
<title><c:if test="${sessionScope.lang == 'en'}">List of supervisor </c:if>
  <c:if test="${sessionScope.lang == 'ar'}">قائمة المشرف</c:if> <c:if
    test="${sessionScope.lang == 'fr'}"> Liste des superviseur</c:if></title>
            ...
            <div class="card">
              <div class="card-header card-header-warning card-header-icon">
                ...
                <h4 class="card-title">
                  ...
                  <c:if test="${sessionScope.lang == 'fr'}"> Liste des superviseur</c:if>
                    ...
                    <table id="datatables"
                      ...
                      <thead>
                        <tr class=" table table-success">
                          <c:if test="${sessionScope.lang == 'en'}"><th>Id</th><th>Name</th><th>Password</th><th>Address</th><th>Phone</th><th>Registration date</th> <th> Action</th></c:if>
  <c:if test="${sessionScope.lang == 'ar'}"><th>Id</th><th>الاسم</th><th>كلمة السر</th><th>عنوان</th><th>رقم الهاتف</th><th>تاريخ التسجيل</th>
  <th>امكانيات</th></c:if> <c:if
    test="${sessionScope.lang == 'fr'}"> <th>Id</th><th>Nom</th><th>Mot de passe</th><th>Adresse</th><th>numéro de téléphone</th><th>Date d'Insciption</th> <th> Action</th></c:if>
                        </tr>
                      </thead>

                      <tbody>
                        <c:if test="${sessionScope.lang == 'en'}">
<c:forEach items = "${ListSuperviseur}"  var = "s">
  ...
  <td>${s.getDateInsc()}</td>
      <td class="td-actions text-center"><a
                                href="Servlet?action=personSuperviseurV&amp;ip=${s.getNom()}">
                                  <button type="button" rel="tooltip" name="person"
                                    class="btn btn-warningA">
                                    <i class="material-icons">person</i>
                                  </button>
                              </a> <a href="Servlet?action=updateProfileSup&amp;id=${s.getIdS()}">
                                  <button type="button" rel="tooltip" name="edit"
                                    class="btn btn-success">
                                    <i class="material-icons">edit</i>
                                  </button>
                              </a>
                                <button type="button" id="${s.getIdS() }"
    ...
    <c:if test="${sessionScope.lang == 'ar'}"><c:forEach items = "${ListSuperviseur}"  var = "s">
  ...
  <td>${s.getDateInsc()}</td> 
      <td class="td-actions text-center"><a
                  ...
                  <c:if test="${sessionScope.lang == 'fr'}"> <c:forEach items = "${ListSuperviseur}"  var = "s">
    ...
    <footer class="footer ">
      ...
      <div class="container">
        <div class="copyright pull-right">
          Science Mathématique et Informatique &copy;
          <script type="text/javascript">
