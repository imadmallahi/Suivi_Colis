    ...
    <c:when test="${sessionScope.lang == 'ar'}">
       <div class="card-body ">
                              ...
                              <span class="bmd-form-group">    	
                                ...
                                <input type="text" class="form-control" id="nomUtii" placeholder="رقم الهاتف " style= "text-align:right;"name="username" required="required" oninvalid="this.setCustomValidity('أدخل رقم هاتفك من فظلمك')" oninput="this.setCustomValidity('')">
...
<div class="card-body ">
                                  ...
                                  <div class="input-group-prepend">
                                    <span class="input-group-text">
                                      <i class="material-icons">lock_outline</i>
                									...
                									<input type="password" class="form-control" placeholder="Password..." name="password" required="required" oninvalid="this.setCustomValidity('Entrepasswrod please !')" oninput="this.setCustomValidity('')">
                									<input type="hidden" name="oky" value="oky">
              								</div>
                            </span>
    ...
    <div class="card-footer justify-content-center">
        ...
        <button type="submit" class="btn btn-info btn-round" name="action" id="connexion" value="ConnecterAgent">
         <c:choose>
