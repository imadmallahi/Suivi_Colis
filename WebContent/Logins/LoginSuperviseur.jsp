   ...
   <div class ="danger-text">
    ...
    <c:when test="${sessionScope.lang == 'ar'}">   <div class="card-body ">
                              ...
                              <span class="bmd-form-group">    	
                                ...
                                <input type="text" class="form-control" id="nomUtii" placeholder="إسم المستخدم" style= "text-align:right;"name="username" required="required" oninvalid="this.setCustomValidity('Entrez le nom d\'utilisateur svp!')" oninput="this.setCustomValidity('')">
                                ...
                                <div class="input-group">
                									...
                									<input type="password" class="form-control" placeholder="كلمة السر" style= "text-align:right;"name="password" required="required" oninvalid="this.setCustomValidity('Entrez le mot de passe svp!')" oninput="this.setCustomValidity('')">
                                  ...
                                  <div class="input-group-prepend">
                                    <span class="input-group-text">
                                      <i class="material-icons">lock_outline</i>
                									...
                									<input type="password" class="form-control" placeholder="Password..." name="password" required="required" oninvalid="this.setCustomValidity('Entre password  please !')" oninput="this.setCustomValidity('')">
                									<input type="hidden" name="oky" value="oky">
              								</div>
                            </span>
    ...
    <div class="card-footer justify-content-center">
        ...
        <button type="submit" class="btn btn-info btn-round" name="action" id="connexion" value="ConnecterSuperviseur">
       <c:choose>
...
<c:if test="${sessionScope.lang == 'en'}"> <script src="Style/js/scriptLangEn.js"></script></c:if>
    <c:if test="${sessionScope.lang == 'ar'}"><script src="Style/js/scriptLangAr.js"></script></c:if>
