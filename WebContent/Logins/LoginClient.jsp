    ...
    <c:when test="${sessionScope.lang == 'ar'}">
        <div class="card-body ">
                              ...
                              <span class="bmd-form-group">    	
                                ...
                                <input type="text" class="form-control" id="nomUtii" placeholder="رقم الهتف" style= "text-align:right;"name="username" required="required" oninvalid="this.setCustomValidity('قم الهاتف ')" oninput="this.setCustomValidity('')">
...
َ<div class="card-body ">
    ...
    <div class="card-footer justify-content-center">
        ...
        <button type="submit" class="btn btn-info btn-round" name="action" id="connexion" value="ConnecterClient">
     <c:choose>
