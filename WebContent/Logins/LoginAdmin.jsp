    ...
    <c:when test="${sessionScope.lang == 'ar'}">
        <div class="card-body ">
                              ...
                              <span class="bmd-form-group">    	
                                ...
                                <input type="text" class="form-control" id="nomUtii" placeholder="رقم الهاتف" style= "text-align:right;"name="username" required="required" oninvalid="this.setCustomValidity('!ادخل رقم هاتفك من فضلك ')" oninput="this.setCustomValidity('')">
                                ...
                                <div class="input-group">
                									...
                									<input type="password" class="form-control" placeholder="كلمة السر" style= "text-align:right;"name="password" required="required" oninvalid="this.setCustomValidity('! أدخل رمز المرور من فظلمك')" oninput="this.setCustomValidity('')">
...
َ<div class="card-body ">
    ...
    <c:otherwise>
        ...
        <button type="submit" class="btn btn-info btn-round" name="action" id="connexion" value="ConnecterAdmin">
         <c:choose>
    <c:when test="${sessionScope.lang == 'ar'}">
        تسجيل الدخول 
