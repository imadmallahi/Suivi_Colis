			...
			<div class="container-fluid">
				...
				<div class="">
					...
					<div class="wizard-container">
						<h3>Bienvenue Mr ${NomCompte}</h3>
						<br>
						<form style="width :80%;" method="post" action="Servlet">
					<c:import url="CommandeCreateFormular.jsp" />
					  <button type="submit" class="btn btn-primary" name="action" value="saveCommandeClient">Submit Client</button>
					</form>
					</div>
					<!-- wizard container -->
				</div>
