				...
				<div class="col-md-12 mr-auto ml-auto">
					...
					<form action="Servlet" method="post">
						<div class="card-header text-center">
							<h3 class="card-title">
								<c:if test="${sessionScope.lang == 'en'}"> update an account</c:if>
											...
											<c:if test="${sessionScope.lang == 'en'}">
												...
												<div class="form-group col-sm-4">
													<label for="examplenom" class="bmd-label-floating">Name
														...
														id="exampleInput1" name="nom" value="${sup.getNom() }">
												</div>
												<div class="input-group-prepend">
													<span class="input-group-text"> <i
												...
												<div class="form-group col-sm-4">
													<label for="examplemail" class="bmd-label-floating">Email
														...</label> <input type="text" class="form-control"
														id="exampleemalil" name="email" value="${sup.getEmail() }">
												</div>
											</c:if>
											<c:if test="${sessionScope.lang == 'ar'}">
												<div class="form-group col-sm-4">
											...
											<c:if test="${sessionScope.lang == 'en'}">
												...
												<div class="form-group col-sm-4">
													<label for="exampleville" class="bmd-label-floating">Country
														...</label> <input type="text" class="form-control"
														id="exampleemalil" name="pays" value="${sup.getCountry() }">
												</div>
												<div class="input-group-prepend">
													<span class="input-group-text"> <i
														class="material-icons">home</i>
												...
												<div class="form-group  col-sm-4">
													<label for="exampleville" class="bmd-label-floating">City
														...</label> <input type="text" class="form-control"
														id="exampleemalil" name="ville" value="${sup.getVille() }">
												</div>
											</c:if>
											<c:if test="${sessionScope.lang == 'ar'}">
												<div class="form-group  col-sm-4">
											...
											<c:if test="${sessionScope.lang == 'en'}">
												...
												<div class="form-group col-sm-8">
													<label for="exampleadress" class="bmd-label-floating">address
														...</label> <input type="text" class="form-control"
														id="exampleemalil" name="adresse" value="${sup.getAdresse() }">
												</div>
											</c:if>
											<c:if test="${sessionScope.lang == 'ar'}">
												<div class="form-group col-sm-8">
												...
												<c:if test="${sessionScope.lang == 'en'}">
													...
													<div class="form-group">
														<label for="exampleInput1" class="bmd-label-floating">Phone
															...
															onkeyup="verif_nombre(this);" value="${sup.getNtele() }">
													</div>
												</c:if>
												<c:if test="${sessionScope.lang == 'ar'}">
													<div class="form-group">
					...
					<input type="hidden" name="id" value="${sup.getIdS() }">
						...
						<div class="card-footer">
							<div class="ml-auto">
								...
								<button type="submit"
									...
									name="action" value="updateDataSuper">Enregistrer les modifications </button>
							</div>
