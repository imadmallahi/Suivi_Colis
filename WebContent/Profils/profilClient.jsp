		...
		<nav
			...
			<div class="container-fluid">
				<div class="navbar-wrapper">
					...
					<c:if test="${sessionScope.lang == 'en'}"><a class="navbar-brand" href="#pablo">Customer profile </a></c:if>
					<c:if test="${sessionScope.lang == 'fr'}"><a class="navbar-brand" href="#pablo">Profil du client </a></c:if>
					<c:if test="${sessionScope.lang == 'ar'}"><a class="navbar-brand" href="#pablo">ملف الزبون </a></c:if>
				</div>
									...
									<div class="form-group">
										<table id="datatables"
											...
											<tr>
												<c:if test="${sessionScope.lang == 'en'}">
													...
													<td align="left">${p.getIdC()}</td>
													<td align="right"></td>
												</c:if>
												<c:if test="${sessionScope.lang == 'ar'}">
													<td align="right">${p.getIdC()}</td>
													<td align="right">رقم الزبون</td>
												</c:if>
												<c:if test="${sessionScope.lang == 'fr'}">
													<td align="left">N° d'adhésion du client</td>
													<td align="left">${p.getIdC()}</td>
													<td align="right"></td>
												</c:if>
											</tr>
											...
											<tr>
												<c:if test="${sessionScope.lang == 'en'}">
													...
													<td align="left">${p.getPays()}</td>
													<td align="right"></td>
												</c:if>
												<c:if test="${sessionScope.lang == 'ar'}">
													<td align="right">${p.getPays()}</td>
										...
										<form method="get" action="Servlet">
											<button class="btn btn-rose btn-round" name="action"
												Value="updateProfileClient" type="submit">
