						...
						<form action="Servlet" method="POST">
							<div class="form_top">
								<div class="">
									<c:choose>
										<c:when test="${sessionScope.lang == 'en'}">
											<div id="tracktxt">Enter your Email !</div>
										</c:when>
										<c:when test="${sessionScope.lang == 'fr'}">
											<div id="tracktxt">Saisissez votre Email !</div>
										</c:when>
										<c:otherwise>
											<div id="tracktxt">أدخل ريدك الالكتزوني</div>
										</c:otherwise>
									</c:choose>
								...
								<div align="center">
									<table >
									<tr>
									<td><input type="radio" id="huey" name="role" value="Client" checked>
									</td>									
									<td><label for="huey">Client</label></td>
									</tr>
									...
									<tr><td><input type="radio" id="dewey" name="role" value="Distributeur"></td>
									<td><label for="dewey">Distibuteur</label></td></tr>
								
								<tr><td>
									<input type="radio" id="dewey" name="role" value="Agent"></td>
								<td>	<label for="dewey">Agent</label></td>
								</tr>
								</table>
								</div>
								...
								<c:choose>
									<c:when test="${sessionScope.lang == 'en'}">
										<button id="suivre" name="action" value="send">Send</button>
									</c:when>
									<c:when test="${sessionScope.lang == 'fr'}">
										<button id="suivre" name="action" value="send">Envoyer</button>
									</c:when>
									<c:otherwise>
										<button id="suivre" name="action" value="send">ارسال</button>
									</c:otherwise>
								</c:choose>
								<br>
								<c:if test="${etat != null}">
									<center>
										<p style="color: #7E097E; font-size: 20px; font-weight: bold;">
											<c:if test="${sessionScope.lang == 'en'}"> N° ${ etat }  </c:if>
											<c:if test="${sessionScope.lang == 'ar'}"> ${etat } : رقم </c:if>
											<c:if test="${sessionScope.lang == 'fr'}"> N° ${ etat } </c:if>
										</p>
									</center>
								</c:if>
							</div>
				...
				<div id="footm" style="background-color: #F4F7F9">
					...
					<div class="container clearer" style="margin-top: 40px;">
						<ul id="fmenud">
							...
							<li class="pageid2"><a href="Servlet">Track Parcel</a></li>
				...
				<div id="footm" style="background-color: #F4F7F9">
					...
					<div class="container clearer" style="margin-top: 40px;">
						<ul id="fmenud">
							...
							<li class="pageid4"><a href="Servlet"></a><a
